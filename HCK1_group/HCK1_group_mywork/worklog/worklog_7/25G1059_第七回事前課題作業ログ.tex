...
\begin{itemize}
  ...
  \item 主要成果：
    \begin{itemize}
      ...
      \item {音量・BPMの5段階写像の検証（No.2113，可変抵抗器をA5へ接続変更）}
...
60\% &
無 &
音量用可変抵抗器をA5へ接続変更し，BPM・音量の5段階写像をシリアルで検証済．機構のハードウェア固定は本体完成待ち． \\
\hline
...
\subsection{日ごとの作業ログ}
    ...
    進行中 &
    50\% &
    BPM用可変抵抗器(A0)の生値デバッグ出力を追加し，5段階写像をシリアルモニタで確認した． \\
    \hline
    ...
    進行中 &
    60\% &
    音量用可変抵抗器をA5へ接続変更し，音量の5段階写像が正しく切り替わることをシリアルモニタで検証した． \\
    \hline
