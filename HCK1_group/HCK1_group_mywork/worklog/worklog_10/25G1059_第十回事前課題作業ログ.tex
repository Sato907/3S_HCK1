...
\begin{itemize}
  ...
  \item 主要成果：
    \begin{itemize}
      \item {通信班と合流し，結合テスト（No.3121, 3141, 3211, 3212）を実施}
...
次に，現在のGCを図\ref{fig:gant11}に示す．達成した項目は緑色で塗られている．

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\columnwidth]{gant11.png}
    \caption{現在のガントチャート}
    \label{fig:gant11}
\end{figure}
