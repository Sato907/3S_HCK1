...
// 各音の長さ(拍)
float[] duration = {
  0.9f, 0.9f, 0.9f,0.9f,0.9f,0.9f,1.8f,0.9f,0.9f,0.9f,0.9f,0.9f,0.9f,0.9f
};
...
//各音の大きさ(振幅)
float[] amplitude = {
  0.5f, 0.6f, 0.7f, 0.8f, 0.9f, 1.0f, 1.1f, 1.2f, 1.3f, 1.4f, 1.5f, 1.6f, 1.7f, 5.0f
};
...
void playSong() {
  ...
  for (int i = 0; i < melody.length; i++) {
    out.playNote(startTime[i], duration[i], 
      new HackInstrument(Frequency.ofPitch(melody[i]).asHz(), amplitude[i] , currentWaveform));
  }
