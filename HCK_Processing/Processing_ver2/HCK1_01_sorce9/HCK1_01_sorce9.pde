...
void playSong() 
{
  ...
  out.playNote(0.0f, 5.0f, new HackInstrument(Frequency.ofPitch("A4").asHz(), 0.5f, currentWaveform));
...
void keyPressed() 
{
  switch (key) 
  {
    ...
    case '4':
      ...
      break;
    case '5':
      // 倍音の振幅値を指定した自作の音色,サンプルサイズ(２の倍数)
      currentWaveform = WavetableGenerator.gen10(4096, new float[] { 1.0f, 0.45f, 0.20f, 0.10f, 0.05f } //各倍音の振幅値
      );
      break;
    case 'p':
      // 作成した信号を出力 
